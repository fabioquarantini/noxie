...
"use strict";jQuery.noConflict(),jQuery(document).ready(function(e){var i={DOMready:function(){e(".slider--primary").length>0&&i.slider(),e('[href$=".jpg"], [href$=".png"], [href$=".gif"]').length>0&&i.modal()},slider:function(){e(".slider--primary").slick({dots:!0,speed:500})},modal:function(){e('[href$=".jpg"], [href$=".png"], [href$=".gif"]').colorbox({transition:"elastic",speed:400,opacity:.8,slideshow:!0,slideshowSpeed:4e3,itemsnitialWidth:50,initialHeight:50,maxWidth:"90%",maxHeight:"90%"})}};i.DOMready()});
